package com.example.thangpnph16377_ass;
...
public class NotifyConfig extends Application {
    public static final String CHANEL_ID = "Thangpnph16377_ASM"; //tự đặt thành tên mới
    ...
    void config() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            // Tên chanel
            CharSequence name = "Facebook"; // tên hiển thị trong cài đặt notify của điện thoại
            // mo ta:
